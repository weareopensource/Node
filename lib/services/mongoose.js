...
module.exports.connect = () => new Promise((resolve, reject) => {
  ...
  if (mongoOptions && mongoOptions.sslCA) mongoOptions.sslCA = fs.readFileSync(mongoOptions.sslCA);
  if (mongoOptions && mongoOptions.sslCert) mongoOptions.sslCert = fs.readFileSync(mongoOptions.sslCert);
  if (mongoOptions && mongoOptions.sslKey) mongoOptions.sslKey = fs.readFileSync(mongoOptions.sslKey);
