...
//       if (err) reject(new Error(`Failed to remove local ${user.username}`));
//       resolve();
//     });
//   }));
// }
...
//       if (err) reject(new Error(`Failed to add local ${user.username}`));
//       else resolve(theuser);
//     });
//   }));
// }
...
//       if (err) reject(new Error(`Failed to find local account ${user.username}`));

//       if (users.length === 0) resolve();
//       else reject(new Error(`Failed due to local account already exists: ${user.username}`));
//     });
//   }));
// }
