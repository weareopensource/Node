...
exports.update = async (user, body, option) => {
    if (!option)
        user = _.assignIn(user, this.removeSensitive(body, config.whitelists.users.update));
    else if (option === 'admin')
        user = _.assignIn(user, this.removeSensitive(body, config.whitelists.users.updateAdmin));
    else if (option === 'recover')
        user = _.assignIn(user, this.removeSensitive(body, config.whitelists.users.recover));
