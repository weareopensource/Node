...
const logger = require(path_1.default.resolve('./lib/services/logger'));
const mongooseService = require(path_1.default.resolve('./lib/services/mongoose'));
const multerService = require(path_1.default.resolve('./lib/services/multer'));
const seed = require(path_1.default.resolve('./lib/services/seed'));
...
describe('Configuration Tests:', () => {
    ...
    beforeAll(() => mongooseService.connect()
        ...
        AuthService = require(path_1.default.resolve('./modules/auth/services/auth.service'));
        UserService = require(path_1.default.resolve('./modules/users/services/user.service'));
        TaskService = require(path_1.default.resolve('./modules/tasks/services/tasks.service'));
    })
        .catch((e) => {
        console.log(e);
    }));
    ...
    describe('Logger', () => {
        beforeEach(() => {
            originalLogConfig = lodash_1.default.clone(config.log, true);
            // mock();
        });
        afterEach(() => {
