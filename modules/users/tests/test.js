...
//       it('should be able to save without problems', async (done) => {
//         const _user1 = new User(user1);

//         const test = await UserService.save(_user1);
...
//         const result = Joi.validate(_user1, schema.User);
//         result.should.be.an('object');
//         result.should.include.keys('error');
//         done();
//       });
