 ...
 */
exports.list = async (req: NodeRequest, res: Response) => {
  try {
 ...
 * @param {Object} res - Express response object
 */
exports.get = (req: NodeRequest, res: Response) => {
 ...
 * @param {Object} res - Express response object
 */
exports.update = async (req: NodeRequest, res: Response) => {
  try {
 ...
 * @param {Object} res - Express response object
 */
exports.delete = async (req: NodeRequest, res: Response) => {
  try {
 ...
 * @param {Object} res - Express response object
 */
exports.stats = async (req: NodeRequest, res: Response) => {
