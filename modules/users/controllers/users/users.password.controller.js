...
exports.reset = async (req, res) => {
  ...
  // check input
  if (!req.body.token || !req.body.newPassword) return responses.error(res, 422, 'Password or Token fields must not be blank')();
  ...
  try {
    ...
    if (user.length !== 1) return responses.error(res, 400, 'Password reset token is invalid or has expired.')();
